              ...
              {items.map((item, idx) => (
                ...
                >
                  ...
                  <Link
                    ...
                    className="w-24 h-24 flex-shrink-0 rounded-sm overflow-hidden bg-secondary hover:opacity-80 transition-opacity"
                  >
                    <img
                      src={
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <div>
                        <Link
                          to={`/product/${item.product_id}`}
                          className="text-sm font-semibold hover:text-primary/70 transition-colors"
                        >
                          {item.product.name}
                        </Link>
