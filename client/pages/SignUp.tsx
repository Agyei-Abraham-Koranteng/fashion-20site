...
export default function SignUp() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 sm:p-12">
            ...
            <p className="mt-4 text-[10px] text-gray-300 uppercase tracking-widest font-bold text-center">
                © 2025 MadeInFashion. All Rights Reserved.
            </p>
            <Link to="/admin/login" className="mt-2 text-[10px] text-gray-300 hover:text-gray-500 transition-colors uppercase tracking-widest font-bold">
                Admin Access
            </Link>
        </div>
    );
