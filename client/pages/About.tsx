...
export default function About() {
    ...
    const content = {
        ...
        story: cmsData?.story || "Founded in the heart of the fashion district, LUXE began with a simple yet ambitious vision: to create clothing that transcends trends and celebrates the enduring beauty of classic design. What started as a small atelier of dedicated artisans has grown into a global destination for those who seek sophistication, quality, and style that stands the test of time.\n\nOur journey is paved with a commitment to excellence. We believe that true luxury lies in the details—the choice of the finest silks, the precision of a tailored seam, and the subtle textures of hand-woven fabrics. Every piece in our collection is a testament to this philosophy, designed to empower our customers and inspire confidence in every moment.",
        mission: cmsData?.mission || "At LUXE, our mission is to redefine modern luxury through ethical craftsmanship and timeless design. We strive to create conscious collections that respect both the artisan and the environment, ensuring that beauty never comes at a cost."
    };
    return (
        <Layout>
